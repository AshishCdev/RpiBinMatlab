...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HelloWorld
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/pi/Rpi_ARM7Cortex
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HelloWorld
...
DEFINES_STANDARD = -DMODEL=HelloWorld -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/HelloWorld_grt_rtw/HelloWorld.c $(START_DIR)/HelloWorld_grt_rtw/rtGetInf.c $(START_DIR)/HelloWorld_grt_rtw/rtGetNaN.c $(START_DIR)/HelloWorld_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = HelloWorld.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_logging.o
...
%.o : $(START_DIR)/HelloWorld_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/HelloWorld_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
